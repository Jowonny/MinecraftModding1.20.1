...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    // DUPLICATE TO ADD MORE ARMOURS
    STEAMPUNKERF("steampunkerf", 5,Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
...
}), 12, SoundEvents.ARMOR_EQUIP_LEATHER, 0F, 0F, () -> {
    return Ingredient.of(Items.LEATHER);
}),
    PLAINSKIRT("steampunkerf", 5,Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 1);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 2);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 3);
        p_266655_.put(ArmorItem.Type.HELMET, 1);
    ...
    PLAIDSKIRT("steampunkerf", 5,Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 1);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 2);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 3);
        p_266655_.put(ArmorItem.Type.HELMET, 1);
